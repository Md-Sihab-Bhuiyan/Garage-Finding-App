...
class Myt_repair_se extends StatefulWidget {
  const Myt_repair_se ({Key? key}) : super(key: key);

  @override
  State<Myt_repair_se > createState() => _Myt_repair_seState();
}

class _Myt_repair_seState extends State<Myt_repair_se > {
  String searchText = '';
  ...
  void filterGarages() {
    ...
    FirebaseFirestore.instance
        .collection('garages')
        .where('repairTire', isEqualTo: true) // Only fetch garages where carWash is true
        .get()
          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('assets/g9.jpg'), // Add your background image
                fit: BoxFit.cover,
              ),
            ),
          ),
