        ...
        <article>
          ...
          -->
            ...
            <section class="hero has-bg-image" aria-label="home"
                style="background-image: url('./assets/images/b4.jpg')">
                <div class="search-container">
                    <h1 class="search-title">Find the Garages For washing car and get best services</h1>
                    <form action="tireresult.php" method="GET" class="search-form">
