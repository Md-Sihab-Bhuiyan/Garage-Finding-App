...
if (isset($_GET['query'])) {
    ...
    $sql = "SELECT name, gname, location, pnumber, email FROM garage_info WHERE (location LIKE '%$search_query%' AND t_repair = 'y') OR (gname LIKE '%$search_query%' AND t_repair = 'y')";
    ...
    <main>
        <article>
            ...
            <div class="search-results-container">
                    <h2 class="search-title">Search Results"<?php echo htmlspecialchars($search_query); ?>" for tire repair </h2>
