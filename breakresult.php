...
if (isset($_GET['query'])) {
    ...
    $sql = "SELECT name, gname, location, pnumber, email FROM garage_info WHERE (location LIKE '%$search_query%' AND br_repair = 'y') OR (gname LIKE '%$search_query%' AND car_wash = 'y')";
        ...
        <div class="container">
            ...
            <nav class="navbar" data-navbar>
                <ul class="navbar-list">
                    ...
                    <li>
                        <a href="cwashu.php" class="navbar-link">Car Wash</a>
                    </li>
    ...
    <main>
        <article>
            ...
            <div class="search-results-container">
                    <h2 class="search-title">Search Results"<?php echo htmlspecialchars($search_query); ?>" for Repair brake </h2>
