    ...
    <main>
      ...
      -->
            ...
            <section class="hero has-bg-image" aria-label="home"
                style="background-image: url('./assets/images/b5.jpg')">
                <div class="container">
                    <div class="hero-content">
                        <h3> Hi </h3>
                        <h1>Welcome<span><?php echo $_SESSION['admin_name']?></span></h1>
                    <a href="add.php" class="btn">
                        <span class="span">Add your Garage</span>
                    </a>
                    <a href="updategarage.php" class="btn" style="margin-top: 10px;">
                        <span class="span">Update your Garage</span>
                    </a>
                    <a href="delategarage.php" class="btn" style="margin-top: 10px;">
                        <span class="span">delate your Garage</span>
                    </a>
                    </div>
                </div>
