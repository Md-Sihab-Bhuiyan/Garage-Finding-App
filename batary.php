...
<body>
    ...
    <main>
        <article>
            <!-- #HERO -->
            <section class="hero has-bg-image" aria-label="home" style="background-image: url('./assets/images/e2.jpg')">
                <div class="search-container">
                    <h1 class="search-title" style="color: yellow;">Find the Garages For Repair Battery and get the best services</h1>
                    <form action="bataryresult.php" method="GET" class="search-form" onsubmit="return validateSearchForm()">
                        <input type="text" name="query" class="search-input" id="search-input" placeholder="Enter your search">
    ...
    <script>
        function validateSearchForm() {
            ...
            if (searchInput.value.trim() === '') {
                alert('Your search is empty. Please enter a search term.');
                return false;
            }
            return true;
        }
