        ...
        <article>
          ...
          -->
            ...
            <section class="hero has-bg-image" aria-label="home"
                style="background-image: url('./assets/images/g2.jpg')">
                <div class="search-container">
                    <h1 class="search-title">Find the Garages For Repair steering and get best services</h1>
                    <form action="steeringresult.php" method="GET" class="search-form">
